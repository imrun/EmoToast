...
public class EmoToast extends Toast {
    /**
    ...
    public EmoToast(Context context) {
        super(context);
    }
    ...
    public static Toast makeText(Context context, String message, int duration, int type, boolean androidicon) {
        ...
        View layout = LayoutInflater.from(context).inflate(R.layout.emotoast_layout, null, false);
...
//            img1.setVisibility(View.GONE);
        if (type == 1) {
            ...
            img.setImageResource(R.drawable.icons_happy);
        } else if (type == 2) {
            linearLayout.setBackgroundResource(R.drawable.warning_shape);
            img.setImageResource(R.drawable.icons_warning);
        } else if (type == 3) {
            linearLayout.setBackgroundResource(R.drawable.error_shape);
            img.setImageResource(R.drawable.icons_angry);
        } else if (type == 4) {
            linearLayout.setBackgroundResource(R.drawable.info_shape);
            img.setImageResource(R.drawable.icons_love);
        } else if (type == 5) {
            linearLayout.setBackgroundResource(R.drawable.default_shape);
            img.setVisibility(View.GONE);
        } else if (type == 6) {
            linearLayout.setBackgroundResource(R.drawable.confusing_shape);
            img.setImageResource(R.drawable.icons_puzzled);
        }
